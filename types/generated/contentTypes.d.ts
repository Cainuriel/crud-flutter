...
export interface ApiUserTemporalUserTemporal extends Schema.CollectionType {
  ...
  attributes: {
    ...
    videogames: Attribute.Relation<
      'api::user-temporal.user-temporal',
      'manyToMany',
...
export interface ApiVideogameVideogame extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user_temporals: Attribute.Relation<
      'api::videogame.videogame',
      'manyToMany',
      'api::user-temporal.user-temporal'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::user-temporal.user-temporal': ApiUserTemporalUserTemporal;
